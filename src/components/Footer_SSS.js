    ...
    <div class="row my-5 justify-content-center py-5">
        <div class="col-11">
            ...
            <div class="row ">
                ...
                <h6 class="mt-55 mt-2 text-muted bold-text"><b>N RAM MOHAN</b>&nbsp;-&nbsp;Managing Director</h6>
                <h6 class="mt-55 mt-2 text-muted bold-text"><b>K SOWMYA LAKSHMI</b>&nbsp;-&nbsp;Head Teacher</h6>
                    <small> 
